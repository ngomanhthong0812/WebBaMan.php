...
<body>
    ...
    <div class="my_body">
        ...
        <div class="product">
            <div class="banner_2">
                <img src="../public/img/product/banner.png" alt="" class="h-100 w-100">
                <div class="content">
                    <b>NOSE RINGS</b>
                    <p>NOSE EARRING</p>
                    <p>25 NOV - 29 NOV</p>
        ...
        <div class="container_sale">
            <div class="sale">
                ...
                <div class="sale_2"><span>2nd shopping surprise campaign!</span><button>Check Products <i
                            class='bx bx-skip-next'></i></button></div>
            </div>
        </div>

        <div class="product">
            <div class="banner_2">
                <img src="../public/img/product/banner_1.png" alt="" class="h-100 w-100">
                <div class="content">
                    <b>NOSE RINGS</b>
                    <p>NECKLACES</p>
                    <p>25 NOV - 29 NOV</p>
        ...
        <div class="featured_Deals">
            <div class="featured_Deals-child--1">
                <div class="featured_Deals-child--2-title">
                    <div><h5>Deals of the Week</h5></div>
                    <div>View All</div>
                </div>
                <div class="my_card">
                    <div class="my_card_1">
                ...
                <div class="Testimonials">
                    ...
                    <div class="banner_4-1">
                        ...
                        <div class="informations" >
                            <p>This is due to their excellent <br> service, competitive pricing and <br> customer support. It’s throughly <br> refresing to get such a personal <br> touch. Duis aute lorem ipsum is <br> simply free text irure dolor in <br> reprehenderit in esse nulla pariatur</p>
                        </div>
                    </div>
            ...
            <div class="featured_Deals-child--2">
                ...
                <div class="featured_Deals-child--2-title">
                    <div><h5>Deals of the Week</h5><span>Dont miss out on this weeks deals</span></div>
                    <div>View All</div>
                </div>
                    ...
                    <div class="product_card">
                        <div class="my_card">
                            <div class="image" onclick="productDetails(1)">
                                ...
                                <div class="icon"><i class='bx bx-refresh'></i><i class='bx bxs-right-arrow'></i></div>
                                <div class="icon" onclick="openZoomCard(1,event)"> <i class='bx bx-fullscreen'></i><i class='bx bxs-right-arrow'></i></div>
                                <div class="icon"><i class='bx bx-shopping-bag'></i><i class='bx bxs-right-arrow'></i></div>
                            </div>
                            <p>The Air Scoop-Neck Tee</p>
                            <div class="price">
                                <div class="star_icon">
                        ...
                        <div class="my_card">
                            ...
                            <p>ERhinestone crystal earring</p>
                            <div class="price">
                                <div class="star_icon">
                                    <i class='bx bxs-star'></i>
                                    <i class='bx bxs-star'></i>
                ...
                <div class="featured_Deals-child--2-banner_3">
                    ...
                    <div class="featured_Deals-child--2-banner_3-1">
                        ...
                        <div class="content">Fashion is about dressing according to what's fashionable. Style is more about being yourself. Design is a constant challenge to balance comfort with luxe...</div>
    ...
    <div class="banner_4">
        ...
        <div>
            <div class="featured_Deals-child--2-banner_3-1">
                ...
                <div class="content">You can hide so much behind theatrics, and I don't need to do that any more. My relationships with producers or photographers - these are relationships that took years.</div>
   ...
   <div class="container_instagram">
    <div class="instagram">
        ...
        <div>
            <div><img src="../public/img/instagram/1.webp" alt=""><img src="../public/img/product/icon.png" alt=""></div>
            <div><img src="../public/img/instagram/2.webp" alt=""><img src="../public/img/product/icon.png" alt=""></div>
            <div><img src="../public/img/instagram/3.webp" alt=""><img src="../public/img/product/icon.png" alt=""></div>
            <div><img src="../public/img/instagram/4.webp" alt=""><img src="../public/img/product/icon.png" alt=""></div>
            <div><img src="../public/img/instagram/5.webp" alt=""><img src="../public/img/product/icon.png" alt=""></div>
            <div><img src="../public/img/instagram/6.webp" alt=""><img src="../public/img/product/icon.png" alt=""></div>
            <div><img src="../public/img/instagram/7.webp" alt=""><img src="../public/img/product/icon.png" alt=""></div>
            <div><img src="../public/img/instagram/8.webp" alt=""><img src="../public/img/product/icon.png" alt=""></div>
        </div>
    </div>
   </div>
